...
const DRIVERS = [
  { pos:1, name:'Kimi Antonelli', team:'Mercedes', flag:'🇮🇹', winPct:45, podiumPct:85, champPct:38, pts:72, champPos:1, color:'#00d2be', verdict:'STRONG PICK', verdictColor:'#2ecc8a',
    bull:['Won last 2 races back to back','Championship leader 72pts','Best car on grid','19yo fearless under pressure'],
    bear:['Inexperience in pressure situations','Russell could outqualify him'] },
  { pos:2, name:'George Russell', team:'Mercedes', flag:'🇬🇧', winPct:43, podiumPct:83, champPct:40, pts:63, champPos:2, color:'#00d2be', verdict:'STRONG PICK', verdictColor:'#2ecc8a',
    bull:['Won Australia Round 1','Same car as Antonelli','Championship title motivation'],
    bear:['Battery issue cost him Japan','Teammate momentum favors Antonelli'] },
  { pos:3, name:'Oscar Piastri', team:'McLaren', flag:'🇦🇺', winPct:11, podiumPct:45, champPct:8, pts:26, champPos:6, color:'#ff8000', verdict:'WATCH', verdictColor:'#f5a623',
    bull:['McLaren brought upgrades for Miami','Finished 2nd in Japan'],
    bear:['Still behind Mercedes pace','Early season DNS hurt points'] },
  { pos:4, name:'Lando Norris', team:'McLaren', flag:'🇬🇧', winPct:9, podiumPct:40, champPct:6, pts:30, champPos:5, color:'#ff8000', verdict:'WATCH', verdictColor:'#f5a623',
    bull:['2025 World Champion','Miami upgrades could suit McLaren'],
    bear:['DNS/DNF early 2026 season','McLaren still off Mercedes pace'] },
  { pos:5, name:'Charles Leclerc', team:'Ferrari', flag:'🇲🇨', winPct:8, podiumPct:35, champPct:5, pts:49, champPos:3, color:'#dc0000', verdict:'LONGSHOT', verdictColor:'#9996b8',
    bull:['3rd in championship — consistent','Ferrari fast in qualifying'],
    bear:['Race pace behind Mercedes','Hamilton internal competition'] },
  { pos:6, name:'Lewis Hamilton', team:'Ferrari', flag:'🇬🇧', winPct:6, podiumPct:30, champPct:3, pts:40, champPos:4, color:'#dc0000', verdict:'LONGSHOT', verdictColor:'#9996b8',
    bull:['7x World Champion — experience','Ferrari improving'],
    bear:['Ferrari behind Mercedes','Leclerc faster teammate'] },
  { pos:7, name:'Max Verstappen', team:'Red Bull', flag:'🇳🇱', winPct:3, podiumPct:15, champPct:2, pts:12, champPos:9, color:'#1e41ff', verdict:'SKIP', verdictColor:'#ef4f6a',
    bull:['4x World Champion — never count out','Red Bull brought upgrades'],
    bear:['Only 12pts after 3 races','Red Bull failed new regulations','Threatened retirement'] },
];
    ...
    <div style={{background:C.bg0,minHeight:'100vh',color:C.t1,fontFamily:"'Inter',system-ui,sans-serif"}}>
      ...
      <div style={{maxWidth:960,margin:'0 auto',padding:'72px 24px 48px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:10,marginBottom:16}}>
          {[{label:'Sprint Qualifying',value:'Fri May 1 · 4:30PM ET'},{label:'Qualifying',value:'Sat May 2 · 4PM ET'},{label:'Race',value:'Sun May 3 · 4PM ET'}].map((item,i) => (
