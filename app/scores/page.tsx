...
// Trade ready data shape — matches what PolymarketComparison passes up
...
function ScoresPageContent() {
  ...
  // Trade panel state — populated by onTradeReady callback
  ...
  // Called by PolymarketComparison once token IDs are available
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {/* ── TRADE PANEL ─────────────────────────────────
                Only shown when we have a real Polymarket URL
                and market data has loaded with token IDs      */}
            {!isPlainTextQuery && tradeData && (
              <TradePanel
                ...
                aiConfidence={tradeData.topOutcome.aiConfidence}
                edge={tradeData.topOutcome.edge}
