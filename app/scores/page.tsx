...
function ScoresPageContent() {
  ...
  // Weights & Sources
  const DEFAULT_WEIGHTS = { news: 35, social: 40, market: 25 };
  ...
  const marketSignal = Math.round((polymarketOdds || 50) * (weights.market / 100));
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-purple-400 font-bold">{weights.market}%</span>
                  </div>
                  <input
                    type="range" min="0" max="100" value={weights.market}
                ...
                <div className="flex justify-between items-center p-3 bg-gray-800 rounded-lg">
                  ...
                  <span className={`font-bold ${
                    weights.news + weights.social + weights.market === 100 ? 'text-green-400' : 'text-red-400'
                  }`}>
                    {weights.news + weights.social + weights.market}% 
                    {weights.news + weights.social + weights.market === 100 ? ' ✓' : ' ✗'}
                  </span>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-900/20 to-black border border-blue-500/30 rounded-lg p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{weights.market}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-900/20 to-black border border-blue-500/30 rounded-lg p-6">
              ...
              <p className="text-gray-300 leading-relaxed text-sm">
                {marketType === 'categorical' ? (
                  `Market race analysis across news (${weights.news}%), social (${weights.social}%), and market data (${weights.market}%). 
