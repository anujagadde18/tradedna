...
function ScoresContent() {
  ...
  const confidence =
    analysis.directional.yes > 50 ? analysis.directional.yes : analysis.directional.no;
  const reliability = calculateReliability(analysis);
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                <DetailRow icon="🗣️" label="Community Buzz" value={`${analysis.components.social.final}%`} desc="Social media sentiment" />
                <DetailRow
                  icon="📰"
                  label="News Headlines"
                ...
                />
                <DetailRow icon="📊" label="Market Data" value={`${analysis.components.technical.final}%`} desc="Technical patterns" />
              </div>
            </div>
            ...
            >
              ...
              <div style={{ display: "grid", gap: 10 }}>
                <MetricRow label="Signal Agreement" value={`${analysis.stats.stability}%`} tooltip="How much all signals agree" />
                <MetricRow label="Confidence Level" value={analysis.directional.convictionTier} tooltip="Overall prediction strength" />
                <MetricRow label="Data Freshness" value="Real-time" tooltip="Using last 24hrs data" />
              </div>
            </div>
            ...
            <div>
                  ...
                  {newsData.articles &&
                    newsData.articles.slice(0, 3).map((article: any, i: number) => (
                      ...
                      >
                        ...
                        <div style={{ fontSize: 11, color: "#71717a" }}>{article.source}</div>
                      </a>
                    ))}
                </div>
              )}
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <span style={{ fontSize: 18 }}>📊</span>
                  <span style={{ fontSize: 14, fontWeight: 700, color: "#e4e4e7" }}>Market Data</span>
                </div>
                ...
                <div style={{ display: "grid", gap: 8 }}>
                  ...
                  >
                    ...
                    <div style={{ fontSize: 11, color: "#71717a" }}>Live prediction market pricing</div>
                  </a>

                  {event.toLowerCase().includes("bitcoin") ||
                  event.toLowerCase().includes("btc") ||
                  event.toLowerCase().includes("crypto") ||
                  event.toLowerCase().includes("eth") ? (
                    <>
                      <a
