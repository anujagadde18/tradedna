...
function ScoresPageContent() {
  ...
  if (isPlain) {
    return (
      <div style={{ background:C.bg0, minHeight:'100vh', color:C.t1, fontFamily:'system-ui,-apple-system,sans-serif' }}>
        <div style={{ height:48, borderBottom:'1px solid '+C.border, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 16px', background:C.bg0 }}>
          ...
          <button onClick={() => router.push('/journal')} style={{ color:C.t2, background:'none', border:'none', cursor:'pointer', fontSize:11 }}>Journal</button>
        </div>
