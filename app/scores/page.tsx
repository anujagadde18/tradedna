...
function ScoresPageContent() {
  ...
  // For price markets, pick the most uncertain level (closest to 50%) as the featured outcome
  // For all others, the highest probability outcome is the top pick
  const topOutcome = (() => {
    ...
    if (outcomeType === 'prices') {
      ...
      if (uncertain.length > 0) {
        // Pick the one closest to 50% — most uncertain
