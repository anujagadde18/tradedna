    ...
    <main style={{ minHeight: "100vh", background: "#070B10", color: "#fff", padding: "72px 20px" }}>
      <div style={{ maxWidth: 920, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 18, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
          <div style={{ padding: 18, borderRadius: 18, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}><div style={{ fontWeight: 700 }}>Social Score</div><div style={{ fontSize: 38, marginTop: 10, fontWeight: 800 }}>{base.social}%</div><div style={{ color: "#9CA3AF", fontSize: 12, marginTop: 6 }}>Base score</div></div>
          <div style={{ padding: 18, borderRadius: 18, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}><div style={{ fontWeight: 700 }}>News Score</div><div style={{ fontSize: 38, marginTop: 10, fontWeight: 800 }}>{base.news}%</div><div style={{ color: "#9CA3AF", fontSize: 12, marginTop: 6 }}>Base score</div></div>
          <div style={{ padding: 18, borderRadius: 18, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}><div style={{ fontWeight: 700 }}>Technical Score</div><div style={{ fontSize: 38, marginTop: 10, fontWeight: 800 }}>{base.technical}%</div><div style={{ color: "#9CA3AF", fontSize: 12, marginTop: 6 }}>Base score</div></div>
        </div>
