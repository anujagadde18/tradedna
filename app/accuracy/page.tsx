...
const PREDICTIONS: Prediction[] = [
  ...
  { id:31, date:'May 05', question:'OKC Thunder beat LA Lakers NBA Playoffs Game 1',  category:'nba',     aiConfidence:87, marketOdds:89,   result:'correct',   actualOutcome:'OKC won 108-90 ✅', edge:-2, notes:'AI gave OKC 87%, market 89% — OKC won convincingly' },
