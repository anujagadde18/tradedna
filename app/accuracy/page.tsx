...
const PREDICTIONS: Prediction[] = [
  ...
  { id:31, date:'May 05', question:'OKC Thunder beat LA Lakers NBA Playoffs Game 1',  category:'sports',     aiConfidence:87, marketOdds:89,   result:'correct',   actualOutcome:'OKC won 108-90 ✅', edge:-2, notes:'AI gave OKC 87%, market 89% — OKC won convincingly' },
    ...
    { id:33, date:'May 19', question:'OKC Thunder beat SA Spurs WCF Game 2', category:'sports', aiConfidence:75, marketOdds:null, result:'correct', actualOutcome:'OKC won 122-113 ✅', edge:null, notes:'AI gave OKC 75% at home — correct' },
  { id:34, date:'May 19', question:'NY Knicks beat Cleveland Cavaliers ECF Game 1', category:'sports', aiConfidence:65, marketOdds:null, result:'correct', actualOutcome:'Knicks won 115-104 OT ✅ Historic comeback', edge:null, notes:'AI gave Knicks 65% — correct, historic 22pt comeback' },
