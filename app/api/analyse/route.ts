...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'knicks': 'New York Knicks: NBA FINALS vs Spurs — LEAD 3-1! Greatest comeback in Finals history — down 29pts in Game 4, won 107-106. OG Anunoby tip-in 1.2 seconds left. Brunson 36pts. ONE WIN FROM CHAMPIONSHIP. Game 5 Saturday June 13 at San Antonio.',
  ...
  'spurs': 'San Antonio Spurs: NBA FINALS vs Knicks — TRAIL 1-3. Led by 29 in Game 4 and LOST 106-107. Historic collapse. Wemby 24pts but team fell apart in second half. Must win Game 5 at home Saturday June 13 or season over.',
