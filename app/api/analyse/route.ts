...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'knicks': 'New York Knicks: NBA FINALS vs Spurs — LEAD 2-0! Won Game 1 105-95, Won Game 2 105-104 thriller. 13 straight playoff wins — historic. Brunson clutch free throws sealed Game 2. KAT 21pts 13reb. Wemby missed buzzer shot. Games 3+4 at MSG — Knicks massive favorites. First Finals since 1999, seeking first title since 1973.',
  ...
  'spurs': 'San Antonio Spurs: NBA FINALS vs Knicks — TRAIL 0-2. Lost Game 1 95-105, Lost Game 2 104-105. Wemby 29pts Game 2 but missed buzzer. Fox 18pts. Must win both MSG games to stay alive. Series deficit is massive — only 13 teams have ever come back from 0-2 in NBA Finals history.',
