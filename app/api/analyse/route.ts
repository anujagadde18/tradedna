...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'knicks': 'New York Knicks: Won Round 1 vs Hawks 4-2. Now Round 2 vs 76ers. WON Game 1 137-98! Jalen Brunson 31PPG. MSG fortress. Series lead 1-0.',
  'lakers': 'Los Angeles Lakers: Beat Rockets in Round 1 4-2. Now vs OKC Round 2. Game 1 tonight 7:30PM CDT. LeBron James still performing. AD 26pts 13reb. Huge underdogs vs OKC at 11.2%.',
  'warriors': 'Golden State Warriors: Stephen Curry still elite shooter',
  '76ers': 'Philadelphia 76ers: UPSET CELTICS 4-3! Won series. Now in Round 2 vs Knicks. Lost Game 1 vs NYK 98-137. Tyrese Maxey 26PPG, but Knicks dominant at MSG.',
  'heat': 'Miami Heat: Jimmy Butler clutch performer, strong playoff culture',
  'spurs': 'San Antonio Spurs: Won Round 1 vs Trail Blazers 4-1. Now Round 2 vs Timberwolves. WON Game 1 102-104. Wembanyama 26pts 14reb dominant. Series lead 1-0.',
...
const NBA_CONTEXT: Record<string, string> = {
  ...
  'thunder': 'Oklahoma City Thunder: 1st seed West. SWEPT Suns 4-0. Now vs Lakers Round 2. Game 1 tonight 7:30PM CDT. SGA 34PPG. OKC 88.8% favorites. Dominant all season.',
    ...
    if (isIPLQuery) {
      ...
      if (teamMatch) {
        ...
        const POINTS: Record<string,{p:number;w:number;l:number;pts:number;nrr:string;form:string}> = {
          ...
          'PBKS':{p:11, w:8, l:0, pts:16, nrr:'+0.812', form:'WWWWWWWW'},
