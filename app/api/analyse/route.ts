...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'knicks': 'New York Knicks: NBA FINALS vs Spurs — LEAD 2-1. Won Games 1+2 on road. LOST Game 3 at MSG 111-115. Brunson 26pts Game 3 but Wemby too dominant. KAT struggled 11pts. Game 4 Wednesday June 10 at MSG 8:30PM ET — must win to go up 3-1.',
  ...
  'spurs': 'San Antonio Spurs: NBA FINALS vs Knicks — TRAIL 1-2. Lost Games 1+2 on road. WON Game 3 at MSG 115-111! Wemby 32pts 8reb 6ast 3blk — historic performance. Castle 23pts. Series alive — Game 4 Wednesday June 10 at MSG 8:30PM ET. Spurs believe now.',
