...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'spurs': 'San Antonio Spurs: WCF vs OKC — TRAIL 2-3. Must win Game 6 tonight at home or eliminated. Won Games 1(Wemby 41pts 2OT) and 4(blowout). Lost Games 2,3,5. Wembanyama needs historic performance. Castle 25pts Game 5 but not enough. Market gives Spurs only 25% chance tonight.',
