...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'knicks': 'New York Knicks: NBA FINALS vs Spurs — WON Game 1 105-95 on road! Brunson 30pts 13 in 4th quarter. Trailed by 14 but 11-0 run to close. 12 straight playoff wins. Knicks lead series 1-0. Game 2 Friday June 5 at San Antonio 8:30PM ET. Spurs -5.5 home favorites Game 2.',
  ...
  'spurs': 'San Antonio Spurs: NBA FINALS vs Knicks — LOST Game 1 95-105 at home. Wemby 26pts but 6-21 shooting. Champagnie 16pts. Must win Game 2 at home Friday June 5. Spurs -5.5 favorites. Home crowd must lift them. Series trail 0-1.',
