...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'spain': 'Spain: #1 FIFA ranked, EURO 2024 champions, dominant tiki-taka style. Pedri, Yamal, Morata, Rodri key players. 17% Polymarket favorite. Strong squad depth. Playing in Group stage.',
  'france': 'France: #2 ranked, Mbappe leads attack. Defensively solid. 17% market odds. Strong contenders. Deschamps tactical setup.',
  'england': 'England: 11% market odds. Bellingham, Saka, Foden in form. Finally building on 2021 EURO final. Strong squad.',
  'brazil': 'Brazil: 9% odds. Vinicius Jr., Rodrygo, Endrick. Most World Cup wins (5) but recent struggles. Playing in USA.',
  'germany': 'Germany: Strong squad, Musiala key. Playing at home continent effectively with US venues. Rebuilding under Nagelsmann.',
  'portugal': 'Portugal: 10% odds. Ronaldo legacy continues, but younger players like Vitinha, Leao stepping up.',
  'argentina': 'Argentina: Defending champions 2022. Messi final World Cup. Strong motivation. 8% odds.',
  ...
  'knicks': 'New York Knicks: NBA FINALS vs Spurs — GAME 1 TONIGHT June 3 at San Antonio 8:30PM ET. Swept Cavaliers 4-0 in ECF. 11 game playoff winning streak. Brunson 26.9PPG playoffs, Anunoby 19.7PPG, KAT 16.9PPG. Mitchell Robinson questionable (finger). First Finals since 1999. Won 2025 NBA Cup vs Spurs 124-113.',
  ...
  'spurs': 'San Antonio Spurs: NBA FINALS vs Knicks — GAME 1 TONIGHT June 3 at home 8:30PM ET. Beat OKC in WCF Game 7 111-103. Wembanyama 23.2PPG playoffs, Castle 19.2PPG, Fox 16.4PPG, Harper 13.1PPG. Spurs -4.5 favorites Game 1. Home court advantage at Frost Bank Center San Antonio. Last Finals appearance was 2014.',
...
const NBA_CONTEXT: Record<string, string> = {
  ...
  'celtics': 'Boston Celtics: 1st seed East, Jayson Tatum 26PPG, defending champions, deepest roster in NBA',  // WORLD CUP 2026 TEAMS
  'spain': 'Spain: #1 FIFA ranked, EURO 2024 champions, dominant tiki-taka style. Pedri, Yamal, Morata, Rodri key players. 17% Polymarket favorite. Strong squad depth. Playing in Group stage.',
  'france': 'France: #2 ranked, Mbappe leads attack. Defensively solid. 17% market odds. Strong contenders. Deschamps tactical setup.',
  'england': 'England: 11% market odds. Bellingham, Saka, Foden in form. Finally building on 2021 EURO final. Strong squad.',
  'brazil': 'Brazil: 9% odds. Vinicius Jr., Rodrygo, Endrick. Most World Cup wins (5) but recent struggles. Playing in USA.',
