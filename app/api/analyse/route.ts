...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'knicks': 'New York Knicks: NBA FINALS vs Spurs — LEAD 3-1! Greatest comeback in Finals history Game 4 — down 29pts, won 107-106. Anunoby tip-in 1.2s left. Brunson 36pts. ONE WIN FROM CHAMPIONSHIP. Game 5 Saturday June 13 at San Antonio 8:30PM ET. Knicks +180 underdogs — Spurs -218 home favorites. Won Games 1+2+4 in comeback fashion. Brunson is the closer.',
