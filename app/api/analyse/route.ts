...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'canada': 'Canada: Host nation. Alphonso Davies electric. Group B vs Bosnia, Qatar, Switzerland. BMO Field Toronto June 12.', 'Spain: #1 FIFA ranked, EURO 2024 champions, dominant tiki-taka style. Pedri, Yamal, Morata, Rodri key players. 17% Polymarket favorite. Strong squad depth. Playing in Group stage.',
