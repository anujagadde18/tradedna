...
const SPORTS_CONTEXT: Record<string, string> = {
  ...
  'celtics': 'Boston Celtics: TRAIL 76ers 3-2 in series. Lost Game 5 tonight 97-113. Defending champions on the brink of elimination. Must win Game 6.',
  'cavaliers': 'Cleveland Cavaliers: 2nd seed East, Donovan Mitchell 28PPG',
  'knicks': 'New York Knicks: LEAD HAWKS 3-2. Winning Game 5 right now 96-80 in Q4. Jalen Brunson 29PPG this series. Home crowd advantage.',
  ...
  '76ers': 'Philadelphia 76ers: LEAD CELTICS 3-2 in series. Won Game 5 tonight 113-97. Joel Embiid playing well, Tyrese Maxey 28PPG this series. HUGE upset in progress.',
  'heat': 'Miami Heat: Jimmy Butler clutch performer, strong playoff culture',
  'spurs': 'San Antonio Spurs: LEAD Trail Blazers 3-1. Victor Wembanyama dominant 24pts 12reb. One win from advancing.',
