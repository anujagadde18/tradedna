// components/customSources/SourceCard.tsx
"use client";

import { CustomSource } from "@/lib/customSources/types";
...
export function SourceCard({ source, onRemove, onToggle, onWeightChange }: SourceCardProps) {
  return (
    <div style={{ 
      padding: "14px 16px", 
      marginBottom: 10, 
        ...
        <div style={{ display: "flex", gap: 8, marginLeft: 16 }}>
          <button
            ...
            style={{ 
              ...
              border: source.enabled ? "1px solid rgba(34,197,94,0.3)" : "1px solid rgba(255,255,255,0.1)", 
      ...
      {source.enabled && (
        <div>
          ...
          <input
            ...
            disabled={source.isDefault && source.weight === 100}
            style={{ 
              width: "100%", 
              height: 6, 
              borderRadius: 3, 
              ...
              cursor: source.isDefault && source.weight === 100 ? "not-allowed" : "pointer",
              WebkitAppearance: "none",
              appearance: "none",
              opacity: source.isDefault && source.weight === 100 ? 0.5 : 1
            }}
          />
          <div style={{ fontSize: 11, color: "#71717a", marginTop: 6 }}>
            {source.isDefault 
              ? "Auto-balances with other sources in this category"
              : "Drag to adjust weight within this category"
            }
          </div>
        </div>
      )}
